...
public interface SucursalRepository extends JpaRepository<Sucursal, String> {
    ...
    void insertSucursal(@Param("nombre") String nombre, @Param("tamanio") Float tamanio, @Param("direccion") String direccion, @Param("telefono") Integer telefono, @Param("codigo_ciudad") Integer codigo_ciudad);
}
